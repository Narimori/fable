...
public final class SkillCommand {
    private static final @NotNull DynamicCommandExceptionType UNKNOWN_SKILL_EXCEPTION = new DynamicCommandExceptionType(id ->
            Text.stringifiedTranslatable("skill.notFound", id)
    );
    private static final @NotNull DynamicCommandExceptionType FAILED_ENTITY_EXCEPTION = new DynamicCommandExceptionType(entityName ->
            Text.translatable("commands.skill.failed.entity", entityName)
    );
    private static final @NotNull Dynamic2CommandExceptionType ADD_FAILURE_EXCEPTION = new Dynamic2CommandExceptionType((entityName, skillName) ->
            Text.translatable("commands.skill.add.failure", entityName, skillName)
    );
    private static final @NotNull Dynamic2CommandExceptionType REMOVE_FAILURE_EXCEPTION = new Dynamic2CommandExceptionType((entityName, skillName) ->
            Text.translatable("commands.skill.remove.failure", entityName, skillName)
    );
    private static final @NotNull Dynamic3CommandExceptionType TEST_FAILURE_EXCEPTION = new Dynamic3CommandExceptionType((entityName, skillName, reason) ->
            Text.translatable("commands.skill.test.failure", entityName, skillName, reason)
    );
    private static final @NotNull Dynamic3CommandExceptionType USE_FAILURE_EXCEPTION = new Dynamic3CommandExceptionType((entityName, skillName, reason) ->
    ...
    private static @NotNull LiteralArgumentBuilder<ServerCommandSource> argumentSkill() {
    ...
    private static @NotNull LiteralArgumentBuilder<ServerCommandSource> argumentGet() {
    ...
    private static @NotNull LiteralArgumentBuilder<ServerCommandSource> argumentAdd() {
    ...
    private static @NotNull LiteralArgumentBuilder<ServerCommandSource> argumentRemove() {
    ...
    private static @NotNull LiteralArgumentBuilder<ServerCommandSource> argumentTest() {
    ...
    private static @NotNull LiteralArgumentBuilder<ServerCommandSource> argumentUse() {
    ...
    private static int executeGet(
        ...
        var skills = getLivingEntity(target).getSkillManager().getSkills();
        if (skills.isEmpty()) {
    ...
    private static int executeAdd(
            ...
            @NotNull Collection<? extends Entity> targets
    ) throws CommandSyntaxException {
    ...
    private static @NotNull LivingEntity getLivingEntity(@NotNull Entity entity) throws CommandSyntaxException {
    ...
    private static @NotNull RegistryEntry<Skill> getSkill(@NotNull Identifier id) throws CommandSyntaxException {
